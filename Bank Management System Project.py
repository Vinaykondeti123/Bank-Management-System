...
def display_all_account():
    Accounts=get_all_accounts()
    print("-"*170)
    print("Account Table".center(170))
    print("-"*170)
...
def account_details(act_no):
    Accounts=get_all_accounts()
    display_account(Accounts[act_no])

def customer_menu(act_no):
    print("-"*170)
    print("Customer Panel".center(170))
    print("-"*170)
    ...
    elif choice==4:account_details(act_no)
    elif choice==0:exit()
    input("Continue...")
...
def main_menu():
    print("-"*170)
    print("Banking System".center(170))
    print("-"*170)
    print("1.Admin Login\n2.Customer Login")
    choice=int(input("Select: "))
    if choice==1:
        ...
        if admin_id=="Vinay" and password=="Vinay@123":
            admin_menu()
        else:
